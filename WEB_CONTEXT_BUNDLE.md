...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.17-kirby-problem-1.17-422db689-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.17"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.17-kirby-problem-1.17-422db689-v1",
      "problem_contract_sha256": "776a3e9b4d699614c8e854e4b7b3d2e483cfbadec420c415960f324d9eb759e1",
      "problem_id": "problem:um-kp-1.17-kirby-problem-1.17-422db689",
      "route_id": "route:um-kp-1.17-kirby-problem-1.17-422db689-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.17-kirby-problem-1.17-422db689-source-fidelity-01",
      "graph_id": "graph:um-kp-1.17-kirby-problem-1.17-422db689-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.17-kirby-problem-1.17-422db689-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.17-kirby-problem-1.17-422db689-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can an alternating link and a non-alternating link have home- omorphic branched double covers?"
          },
          "statement_sha256": "aba5ebc4efbf54e31720021afc84884e8b8b4e1674ef7f2cbcdc52231aa46a59"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.17-kirby-problem-1.17-422db689-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.17-kirby-problem-1.17-422db689-root",
      "route_id": "route:um-kp-1.17-kirby-problem-1.17-422db689-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.17-02602840cbdd",
        "url": "https://www.unsolvedmath.com/problems/KP-1.17"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
